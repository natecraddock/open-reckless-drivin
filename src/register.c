...
//   ICInstance inst;
//   int icFailed = true;
// order.kagi.com/?F6";    Str255 url = "\phttp:
...
// order.kagi.com/?F6' into your browser.",          "'http:
//         &alertParam, &alertHit));
//   Exit();
// } break;
// case kCodeButton:
...
// and launch Register from the Finder", &alertParam, &hit)); else
// if(err==fnfErr) DoError(StandardAlert(kAlertStopAlert,
