...
// inline Ptr DrawBorder(Ptr drawPos,int xDrawStart,int x1,int x2,int y,Ptr
// data)
// {
//         int v=(-y&0x007f)<<4;
//         int u=0;
...
// Ptr DrawBorderLine(Ptr drawPos,int xDrawStart,int x1,int x2,int y,Ptr
// data,Ptr leftBorder,Ptr rightBorder)
// {
